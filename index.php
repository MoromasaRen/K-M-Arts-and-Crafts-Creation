      ...
      <div class="max-w-screen-xl mx-auto flex flex-col lg:flex-row gap-10 px-6">
        ...
        <div class="lg:w-2/3 w-full relative px-10">
          ...
          <div id="product-scroll" class="flex flex-nowrap gap-6 items-center overflow-x-auto scroll-smooth pb-8 justify-center">
            <!-- Product Card 1 -->
            <div class="relative flex flex-col items-center border shadow-lg p-4 rounded-lg bg-white w-1/3 transition-all duration-300 hover:bg-white/10 hover:backdrop-blur-md hover:border-white/30 hover:shadow-xl">
              <img src="/K-M-Arts-and-Crafts-Creation/assets/flower pictures(no names)/1.png" alt="Blue Orchid Bouquet" class="rounded-lg w-full h-auto object-cover" />
              <div class="absolute bottom-[-16px] left-1/2 transform -translate-x-1/2 bg-[#1a3550] text-white text-xs font-semibold px-2 py-1 rounded-full">
                P385
              </div>
            </div>
            ...
            <!-- Product Card 2 -->
            <div class="relative flex flex-col items-center border shadow-lg p-4 rounded-lg bg-white w-1/3 transition-all duration-300 hover:bg-white/10 hover:backdrop-blur-md hover:border-white/30 hover:shadow-xl">
              <img src="/K-M-Arts-and-Crafts-Creation/assets/flower pictures(no names)/7.png" alt="Blue Tulips Bouquet" class="rounded-lg w-full h-auto object-cover" />
              <div class="absolute bottom-[-16px] left-1/2 transform -translate-x-1/2 bg-[#1a3550] text-white text-xs font-semibold px-2 py-1 rounded-full">
                P155
              </div>
            </div>
            ...
            <!-- Product Card 3 -->
            <div class="relative flex flex-col items-center border shadow-lg p-4 rounded-lg bg-white min-w-[270px] transition-all duration-300 hover:bg-white/10 hover:backdrop-blur-md hover:border-white/30 hover:shadow-xl">
              <img src="/K-M-Arts-and-Crafts-Creation/assets/flower pictures(no names)/14.png" alt="Lily Bouquet" class="rounded-lg w-[270px] h-auto object-cover" />
              <div class="absolute bottom-[-16px] left-1/2 transform -translate-x-1/2 bg-[#1a3550] text-white text-xs font-semibold px-2 py-1 rounded-full">
                P155
              </div>
            </div>
            ...
            <!-- Product Card 4 -->
            <div class="relative flex flex-col items-center border shadow-lg p-4 rounded-lg bg-white min-w-[270px] transition-all duration-300 hover:bg-white/10 hover:backdrop-blur-md hover:border-white/30 hover:shadow-xl">
              <img src="/K-M-Arts-and-Crafts-Creation/assets/flower pictures(no names)/20.png" alt="Pink Bouquet" class="rounded-lg w-[270px] h-auto object-cover" />
              <div class="absolute bottom-[-16px] left-1/2 transform -translate-x-1/2 bg-[#1a3550] text-white text-xs font-semibold px-2 py-1 rounded-full">
                P155
              </div>
            </div>
            ...
            <!-- Product Card 5 -->
            <div class="relative flex flex-col items-center border shadow-lg p-4 rounded-lg bg-white min-w-[270px] transition-all duration-300 hover:bg-white/10 hover:backdrop-blur-md hover:border-white/30 hover:shadow-xl">
              <img src="/K-M-Arts-and-Crafts-Creation/assets/flower pictures(no names)/26.png" alt="Blue Garden Bouquet" class="rounded-lg w-[270px] h-auto object-cover" />
              <div class="absolute bottom-[-16px] left-1/2 transform -translate-x-1/2 bg-[#1a3550] text-white text-xs font-semibold px-2 py-1 rounded-full">
                P165
              </div>
            </div>
