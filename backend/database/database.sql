...
('1DZ', 'Roses', 999, 200, 'in stock'),
('6 Sunrise 2', 'Sunflower and Roses', 880, 200, 'in stock'),
('6 Sunrise Bloom', 'Red Roses Pink Roses', 880, 200, 'in stock'),
('6R Black', 'Red Roses Black Cello', 510, 200, 'in stock'),
('6R Green', 'Red Roses Green Cello', 500, 200, 'in stock'),
('6R Vio', 'Roses Violet Cello', 500, 200, 'in stock'),
('6R White', 'Roses White Cello', 510, 200, 'in stock'),
('6R2 White', 'Roses White Cello v2', 610, 200, 'in stock'),
('7R Green', 'Roses Green Cello', 550, 200, 'in stock'),
('8R Blue', 'Roses Blue Cello', 550, 200, 'in stock'),
('8R Sunrise', 'Sunflower and Roses', 989, 200, 'in stock'),
('Baby Blooms', 'Small Mixed Flowers White Cello', 488, 200, 'in stock'),
('Beige Lily', 'Beige Lily White Cello', 160, 200, 'in stock'),
('Blue Fade', 'Blue Lily Blue Cello', 245, 200, 'in stock'),
('Blue Gerbera', 'Blue Gerbera Blue Cello', 165, 200, 'in stock'),
('Blue Lily', 'Blue Lily Flower Single Blue Cello', 185, 200, 'in stock'),
('Blue Lily', 'Blue Lily Bouquet Blue Cello', 385, 200, 'in stock'),
('Blue Star Garden', 'Blue Lily Bouquet Special Light Blue Cello', 655, 200, 'in stock'),
('Blue Tulip', 'Blue Tulip White Cello', 155, 200, 'in stock'),
('Blush Lily', 'Pink Lily Flower Pink Cello', 155, 200, 'in stock'),
('Blush Star Garden', 'Pink Lily Bouquet Special Light Pink Cello', 655, 200, 'in stock'),
('Blush Tulip', 'Pink Tulip Pink Cello', 155, 200, 'in stock'),
('Dark Lilac Lily', 'Purple Lilac Lily Purple Cello', 385, 200, 'in stock'),
('Elegance Bloom', 'Red Lily Garden White Cello', 488, 200, 'in stock'),
('Fade Pink Lily', 'Pink Lily Bouquet Pink Cello', 385, 200, 'in stock'),
('Floral Mix', 'Mixed Floral Bouquet', 485, 200, 'in stock'),
('Fortune Bloom', 'Special Themed Bouquet Custom', 500, 200, 'in stock'),
('Grand Custom', 'Custom Grand Bouquet', 1199, 200, 'in stock'),
('Grand Garden', 'Assorted Pink Lily Bouquet', 520, 200, 'in stock'),
('Green Star Garden', 'Green Lily Bouquet Special Light Green Cello', 655, 200, 'in stock'),
('Lilac Blush', 'Lilac Bouquet Purple Cello', 385, 200, 'in stock'),
('Lilac Lily', 'Purple Lilac Lily Purple Cello', 155, 200, 'in stock'),
('Pink Garden', 'Pink Lily Garden Bouquet', 489, 200, 'in stock'),
('PinVio', 'Pink and Violet Lily Bouquet', 520, 200, 'in stock'),
('Purple Star Garden', 'Purple Lily Bouquet Special Light Purple Cello', 655, 200, 'in stock'),
('Sunrise Sunflower', 'Sunflower White Cello', 165, 200, 'in stock'),
('Wild Garden', 'Pink Lily Special Bouquet', 489, 200, 'in stock');
