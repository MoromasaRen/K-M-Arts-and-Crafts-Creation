...
<body class="bg-[#d3e1f9] min-h-screen flex">
  <aside class="bg-white w-[350px] flex flex-col p-6">
    ...
    <nav class="flex flex-col space-y-3 text-lg font-bold text-[#0f2e4d] tracking-wide">
      ...
      <a class="pl-4 py-1 px-2 rounded hover:bg-blue-100" href="Dashboard.php">Dashboard</a>
      ...
      <a class="mt-6 py-1 px-2 rounded hover:bg-blue-100" href="Profile.php">Profile</a>
    </nav>
  </aside>
